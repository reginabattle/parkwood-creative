...
// Tabs
(function(e,t,n,r){"use strict";var i={callback:e.noop,deep_linking:true,init:false},s={init:function(t){i=e.extend({},i,t);return this.each(function(){if(!i.init)s.events();if(i.deep_linking)s.from_hash()})},events:function(){e(n).on("click.fndtn",".tabs a",function(t){s.set_tab(e(this).parent("dd, li"),t)});i.init=true},set_tab:function(t,n){var r=t.closest("dl, ul").find(".active"),s=t.children("a").attr("href"),o=/^#/.test(s),u=e(s+"Tab");if(o&&u.length>0){if(n&&!i.deep_linking)n.preventDefault();u.closest(".tabs-content").children("li").removeClass("active").css("opacity", "0");u.css("opacity","1").addClass("active")}r.removeClass("active");t.addClass("active");i.callback()},from_hash:function(){var n=t.location.hash,r=e('a[href="'+n+'"]');r.trigger("click.fndtn")}};e.fn.foundationTabs=function(t){if(s[t]){return s[t].apply(this,Array.prototype.slice.call(arguments,1))}else if(typeof t==="object"||!t){return s.init.apply(this,arguments)}else{e.error("Method "+t+" does not exist on jQuery.foundationTabs")}}})(jQuery,this,this.document)